...
export function checkCasinocoinBip32Path(path: string): void {
  if (!path.startsWith("44'/148'")) {
    throw new Error(
      "Not a Casinocoin BIP32 path. Path: " +
        path +
        "." +
        " The Casinocoin app is authorized only for paths starting with 44'/148'." +
        " Example: 44'/148'/0'"
    );
  }
